 ...
 <ul>
   ...
   execution while performing these actions (see variable 'transmission_time'). Otherwise, the latter information may be mixed with 
   with photodiode events, thus complicating proper data retrieval.</li>
 </ul><br>
