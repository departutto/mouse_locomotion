 ...
 <ul>
   ...
   <li>To start stimulus presentation, push button 'Start test' in the graphical user interface on the Control PC, and 'Stop test'
   otherwise.</li>
   ...
   PC and to be able to quit Matlab.</li>
 </ul><br>
