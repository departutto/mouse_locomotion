...
function client_mappingRF
    ...
    %   param #3 - duration of one flashing square, frames;
    %   param #4 - duration of inter-stimulus interval (ISI), frames;
    %   param #5 - color of the flashing squares, unsigned byte;
    %   param #6 - color of the blank screen during ISI, unsigned byte.
    command_template = 'server_mappingRF(window_pointer, %02d, 18, 36, 255, 0)';
