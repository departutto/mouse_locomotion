...
function client_stimRepetition
    ...
    %   param #10 - time between the test stimulus offset and the trial end, frames.
                                                                                   % x   y 
    command_template = 'server_stimRepetition(window_pointer, %02d, 18, 18, 75,   1,   1, 1, 50, 60)';
    ...
    % Stimuli.   
    filenames = {'.\stim_set_id_008\13.jpg;', '.\stim_set_id_008\14.jpg;', '.\stim_set_id_008\15.jpg;', '.\stim_set_id_008\16.jpg;', '.\stim_set_id_008\17.jpg;', '.\stim_set_id_008\18.jpg'}; 
