...
<img src='locomotion.txt.jpg' height="236" width="320"><br>
...
inter-stimulus intervals in data points (see figure above). The number of inter-stimulus intervals is equal to the number of stimulus presentations minus 1. Duration of stimulus presentations must be 
the same over the entire recordings session. 
<br>
