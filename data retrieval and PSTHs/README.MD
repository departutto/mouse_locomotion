...
<b>Note</b> that the 1st retrieved trial is usually corrupted. For this reason I recommend to remove it by typing 'trials = trials(2:end)' in the Matlab command line and save such edited data
